 ...
 :   :/___/  :        
  :       :   :        
   :_______:   :    StarsXTools ${version}
           /   /    Owner: Mikku
          /   /     Premium: true
          :  /      WhatsApp: 6287784054056
           :/       Telegram: @MikkuChuan
                    Portable Tools DDoS By MikkuBot
========================================================================`)}
// [========================================] //
...
async function bootup() {
  try {
    ...
    console.log(`|| ▓▓░░░░░░░░ || 20%`);
    const getLatestVersion = await fetch('https://raw.githubusercontent.com/MikkuBot/cache/main/version.txt');
    const latestVersion = await getLatestVersion.text()
    console.log(`|| ▓▓▓░░░░░░░ || 30%`);
    if (version === latestVersion.trim()) {
    console.log(`|| ▓▓▓▓▓▓░░░░ || 60%`);
    
    const secretBangetJir = await fetch('https://raw.githubusercontent.com/MikkuBot/cache/main/sigma.txt');
    const password = await secretBangetJir.text();
    await console.log(`Login Key Required`)
    permen.question('[\x1b[1m\x1b[31mMikkuBot Password\x1b[0m]: \n', async (skibidi) => {
      if (skibidi === password.trim()) {
        ...
        await sleep(700)
        console.clear()
        console.log(`Welcome To MikkuBot Tools ${version}`)
        await sleep(1000)
		    await banner()
...
Type exit To Stop
`);
permen.question('[\x1b[1m\x1b[31mMikkuBot Wifi Killer\x1b[0m]: \n', async (yakin) => {
if (yakin === 'exit') {
...
permen.question('[\x1b[1m\x1b[31mMikkuBot Chat AI\x1b[0m]: \n', async (yakin) => {
if (yakin === 'exit') {
...
const getNews = await fetch(`https://raw.githubusercontent.com/MikkuBot/cache/main/news.txt`)
const latestNews = await getNews.text();
const creatorCredits = `
Created And Coded Full By MikkuBot
...
Allah SWT
`
permen.question('[\x1b[1m\x1b[32mMikkuBot Console\x1b[0m]: \n', (input) => {
...
| news         | show latest MikkuBot news
| ai           | Chat With Ai
...
${creatorCredits}`);
    ...
    console.log(`MikkuBot Ai Ragbot Started
